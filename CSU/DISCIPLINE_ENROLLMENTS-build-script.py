...
TABLE_NAME = "DISCIPLINE_ENROLLMENTS"
COLUMNS = ["Campus", "Discipline", "Year", "Undergraduate", "Graduate"]
INPUT_CSV = BASE_DIR / "discipline-enrollments.csv"
OUTPUT_SQL = BASE_DIR / "CSU-build-DISCIPLINE_ENROLLMENTS.sql"

FIELD_SPECS = [
    ("Campus", "Campus", "int"),
    ("Discipline", "Discipline", "int"),
    ("Year", "Year", "int"),
    ("Undergraduate", "Undergraduate", "int"),
    ("Graduate", "Graduate", "int")
]
