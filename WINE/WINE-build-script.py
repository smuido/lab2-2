...
TABLE_NAME = "WINE"
COLUMNS = ["No", "Grape", "Winery", "Name", "Appellation", "Year", "Price", "Score", "Cases", "Drink"]
INPUT_CSV = BASE_DIR / "wine.csv"
OUTPUT_SQL = BASE_DIR / "WINE-build-WINE.sql"

FIELD_SPECS = [
    ("No", "No", "int"),
    ("Grape", "Grape", "varchar(50)"),
    ("Winery", "Winery", "varchar(20)"),
