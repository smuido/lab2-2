...
TABLE_NAME = "APPELLATION"
COLUMNS = ["No", "Appellation", "County", "State", "Area", "isAVA"]
INPUT_CSV = BASE_DIR / "appellations.csv"
OUTPUT_SQL = BASE_DIR / "WINE-build-APPELLATION.sql"

FIELD_SPECS = [
    ("No", "No", "int"),
    ("Appellation", "Appellation", "varchar(50)"),
    ("County", "County", "varchar(30)"),
    ("State", "State", "varchar(30)"),
    ("Area", "Area", "varchar(30)"),
    ("isAVA", "isAVA", "varchar(3)")
]
